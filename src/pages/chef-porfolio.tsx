    ...
    return (
        <Container>
            <div id='chef-porfolio-center' style={{ margin: '30px 0 40px' }}>
                <div>
                    <img className='chef-porfolio-photo' src={chef[0].photo} alt={chef[0].name} />
                    <div className='chef-porfolio-text'>
                        {chef[0].name}
                    </div>
            ...
            <div id='chef-porfolio-center'>
                <div>
                    <h2 className="chef-porfolio-recipes">
                        Recipes
                    </h2>
                    {article.length !== 0 ? <div className='chef-porfolio-recipe-container'>
                        ...
                        <div id='chef-porfolio-center' style={{ height: '350px', alignItems: 'center' }} className="chef-porfolio-recipe">
                            Empty
                        </div>}
                </div>
            </div>
